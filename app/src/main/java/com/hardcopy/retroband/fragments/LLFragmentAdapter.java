...
public class LLFragmentAdapter extends FragmentPagerAdapter {
	...
	public static final int FRAGMENT_POS_BALANCE = 3;
    ...
    private Fragment mBalanceFragment = null;
	...
	public CharSequence getPageTitle(int position) {
		...
		switch (position) {
			...
			case FRAGMENT_POS_BALANCE:
				return mContext.getString(R.string.title_balance).toUpperCase(l);
			default:
				break;
		}
		return null;
